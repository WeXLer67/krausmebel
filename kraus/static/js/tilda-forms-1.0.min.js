    ...
    $.mask = { definitions: { 9: "[0-9]", a: "[A-Za-z]", "а": "[А-Яа-яЁё]", "*": "[A-Za-zА-Яа-яЁё0-9]" }, autoclear: !0, dataName: "rawMaskFn", placeholder: "_" }, $.fn.extend({
        ...
        mask: function(mask, settings) {
            ...
            return settings = $.extend({ autoclear: $.mask.autoclear, placeholder: $.mask.placeholder, completed: null }, settings), defs = $.mask.definitions, tests = [], partialPosition = len = mask.length, firstNonMaskPos = null, mask = String(mask), $.each(mask.split(""), (function(i, c) { "?" == c ? (len--, partialPosition = i) : defs[c] ? (tests.push(new RegExp(defs[c])), null === firstNonMaskPos && (firstNonMaskPos = tests.length - 1), i < partialPosition && (lastRequiredNonMaskPos = tests.length - 1)) : tests.push(null) })), this.trigger("unmask").each((function() {
                ...
                function getPlaceholder(i) { return i < settings.placeholder.length ? settings.placeholder.charAt(i) : settings.placeholder.charAt(0) }
                ...
                function androidInputEvent(e) {
                    var curVal = input.val(),
                        pos = input.caret(),
                        proxy = function() { $.proxy($.fn.caret, input, pos.begin, pos.begin)() };
                    if (oldVal && oldVal.length && oldVal.length > curVal.length) {
                        for (var nextPos = checkVal(!0), curPos = pos.end; curPos > 0 && !tests[curPos - 1];) curPos--;
                        0 === curPos && (curPos = nextPos), pos.begin = curPos, setTimeout((function() { proxy(), tryFireCompleted() }), 0)
                    } else pos.begin = checkVal(!0), setTimeout((function() { proxy(), tryFireCompleted() }), 0)
                }

                function blurEvent(e) { checkVal(), input.val() != focusText && input.change() }
                    ...
                    if (!input.prop("readonly")) {
                        ...
                        if (!(e.ctrlKey || e.altKey || e.metaKey || k < 32) && k && 13 !== k) {
                            if (pos.end - pos.begin != 0 && (clearBuffer(pos.begin, pos.end), shiftL(pos.begin, pos.end - 1)), (p = seekNext(pos.begin - 1)) < len && (c = String.fromCharCode(k), tests[p].test(c))) {
                                var proxy;
                                if (shiftR(p), buffer[p] = c, writeBuffer(), next = seekNext(p), android) setTimeout((function() { $.proxy($.fn.caret, input, next)() }), 0);
                ...
                function clearBuffer(start, end) { var i; for (i = start; i < end && i < len; i++) tests[i] && (buffer[i] = getPlaceholder(i)) }
                ...
                input.data($.mask.dataName, (function() { return $.map(buffer, (function(c, i) { return tests[i] && c != getPlaceholder(i) ? c : null })).join("") })), input.one("unmask", (function() { input.off(".mask").removeData($.mask.dataName) })).on("focus.mask", (function() {
                    var pos;
                    input.prop("readonly") || (clearTimeout(caretTimeoutId), focusText = input.val(), pos = checkVal(), caretTimeoutId = setTimeout((function() { input.get(0) === document.activeElement && (writeBuffer(), pos == mask.replace("?", "").length ? input.caret(0, pos) : setTimeout((function() { input.caret(pos) }), 50)) }), 10))
                })).on("blur.mask", blurEvent).on("keydown.mask", keydownEvent).on("keypress.mask", keypressEvent).on("input.mask paste.mask", (function() {
                    if (!input.prop("readonly")) {
                        if (0 === input.attr("data-tilda-mask").indexOf("+7")) {
...
function($) {
    window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.tildaForm = { versionLib: "01.001", endpoint: "forms.tildacdn.com", isRecaptchaScriptInit: !1, currentFormProccessing: !1, arMessages: { EN: { success: "Thank you! Your data has been submitted.", successorder: "Thank you! Order created. Please wait. We are going to the payment..." }, RU: { success: "Спасибо! Данные успешно отправлены.", successorder: "Спасибо! Заказ оформлен. Пожалуйста, подождите. Идет переход к оплате...." }, UK: { success: "Дякую! Дані успішно відправлені.", successorder: "Дякую! Замовлення оформлене. Будь ласка зачекайте. Йде перехід до оплати..." }, PL: { success: "Dziękuję! Dane wysłane pomyślnie.", successorder: "Dziękuję! Twoje zamówienie potwierdzono. Proszę czekać. Przechodzimy do płatności..." } }, arValidateErrors: { EN: { email: "Please enter a valid email address", url: "Please put a correct URL", phone: "Please put a correct phone number", number: "Please put a correct number", date: "Please put a correct date", time: "Please put a correct time (HH:mm)", name: "Please put a name", namerus: "Please put a correct name (only cyrillic letters)", nameeng: "Please put a correct name (only latin letters)", string: "You put incorrect symbols. Only letters, numbers and punctuation symbols are allowed", req: "Please fill out all required fields", reqfield: "Required field", minlength: "Value is too short", maxlength: "Value too big", emptyfill: "None of the fields are filled in", promocode: "Please activate promo code or clear input", chosevalue: "Please select an address from the options", deliveryreq: "It is not possible to place an order without delivery. Please refresh the page and try again" }, RU: { email: "Укажите, пожалуйста, корректный email", url: "Укажите, пожалуйста, корректный URL", phone: "Укажите, пожалуйста, корректный номер телефона", number: "Укажите, пожалуйста, корректный номер", date: "Укажите, пожалуйста, корректную дату", time: "Укажите, пожалуйста, корректное время (ЧЧ:ММ)", name: "Укажите, пожалуйста, имя", namerus: "Укажите, пожалуйста, имя (только кириллица)", nameeng: "Укажите, пожалуйста, имя (только латиница)", string: "Вы написали некорректные символы. Разрешены только буквы, числа и знаки пунктуации", req: "Пожалуйста, заполните все обязательные поля", minlength: "Слишком короткое значение", maxlength: "Слишком длинное", reqfield: "Обязательное поле", emptyfill: "Ни одно поле не заполнено", promocode: "Активируйте, пожалуйста промокод или очистите поле", chosevalue: "Пожалуйста, выберите адрес из предложенных вариантов", deliveryreq: "Невозможно оформить заказ без доставки. Пожалуйста, перезагрузите страницу и попробуйте еще раз." }, UK: { email: "Вкажіть, будь ласка, коректний email", url: "Вкажіть, будь ласка, коректний URL", phone: "Вкажіть, будь ласка, коректний номер телефону", number: "Вкажіть, будь ласка, коректний номер", date: "Вкажіть, будь ласка, коректну дату", time: "Вкажіть, будь ласка, коректний час (ГГ: ХХ)", name: "Вкажіть, будь ласка, ім'я", namerus: "Вкажіть, будь ласка, ім'я (тільки кирилиця)", nameeng: "Вкажіть, будь ласка, ім'я (тільки латиниця)", string: "Ви написали некоректні символи. Дозволені лише літери, числа і знаки пунктуації", req: "Будь ласка, заповніть всі обов'язкові поля", minlength: "Занадто коротке значення", maxlength: "Занадто довге", reqfield: "Обов'язкове поле", emptyfill: "Жодне поле не заповнено", promocode: "Активуйте, будь ласка промокод або очистіть поле", chosevalue: "Будь ласка, виберіть адресу із запропонованих варіантів", deliveryreq: "Неможливо оформити замовлення без доставки. Будь ласка, перезавантажте сторінку і спробуйте ще раз." }, PL: { email: "Wpisz poprawny email", url: "Wpisz poprawny URL", phone: "Wpisz poprawny nr telefonu", number: "Wpisz poprawny numer", date: "Wpisz poprawną datę", time: "Wpisz poprawną godzinę (god:min)", name: "Wpisz pełne imię", namerus: "Wpisz imię", nameeng: "Wpisz imię", string: "Wpisane niepoprawne symbole, akceptowane litery, cyfry i znaki interpunkcyjne", req: "Proszę wypełnić wszystkie pola", minlength: "Za krótko", maxlength: "Zbyt długie", reqfield: "Pole obowiązkowe", emptyfill: "Żadne pole nie jest wypełnione", promocode: "Aktywuj kod promocyjny lub wyczyść pole", chosevalue: "Proszę wybrać adres wśród oferowanych opcji", deliveryreq: "Nie można złożyć zamówienia bez wysyłki. Przeładuj stronę i spróbuj ponownie" } } }, $(document).ready((function() {
        window.tildaForm.captchaCallback = function(token) {
            ...
            if ($jform.find(".js-tilda-rule").each((function() {
                    ...
                    if (val.length > 0 && (isEmptyValue = !1), minlength && (minlength = parseInt(minlength)), maxlength && (maxlength = parseInt(maxlength)), 1 == req && (0 == val.length && 0 == valnospace.length || ("checkbox" == $(this).attr("type") || "radio" == $(this).attr("type")) && 0 == $(this).closest("form").find('[name="' + $(this).attr("name") + '"]:checked').length)) error.type.push("req");
                        ...
                        switch (rule) {
                            case "email":
                                regExp = /^(?!\.)(?!.*\.\.)[a-zA-Zёа-яЁА-Я0-9\u2E80-\u2FD5\u3190-\u319f\u3400-\u4DBF\u4E00-\u9FCC\uF900-\uFAAD_\.\-\+]{0,63}[a-zA-Zёа-яЁА-Я0-9\u2E80-\u2FD5\u3190-\u319f\u3400-\u4DBF\u4E00-\u9FCC\uF900-\uFAAD_\-\+]@[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéû0-9][a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéû0-9\.\-]{0,253}\.[a-zA-Zёа-яЁА-Я]{2,10}$/gi, val.length > 0 && !val.match(regExp) && error.type.push("email");
                                break;
                            case "url":
                            ...
                            case "number":
                                ...
                                break;
                            case "date":
                                var format = { "DD-MM-YYYY": /^(0[1-9]|1[0-9]|2[0-9]|3[01])[\-\.\/](0[1-9]|1[012])[\-\.\/][0-9]{4}$/, "MM-DD-YYYY": /^(0[1-9]|1[012])[\-\.\/](0[1-9]|1[0-9]|2[0-9]|3[01])[\-\.\/][0-9]{4}$/, "YYYY-MM-DD": /^[0-9]{4}[\-\.\/](0[1-9]|1[012])[\-\.\/](0[1-9]|1[0-9]|2[0-9]|3[01])$/ };
                            ...
                            case "chosevalue":
                                ...
                                break;
                            case "promocode":
                                !("y" === $jform.attr("data-formcart") && valnospace.length > 0 && window.tcart) || window.tcart.promocode && window.tcart.prodamount_discountsum || error.type.push("promocode");
                                break;
                            case "deliveryreq":
            ...
            ($jform = $($jform)).find(".js-errorbox-all").hide(), $jform.find(".js-rule-error").hide(), $jform.find(".js-error-rule-all").html(""), $jform.find(".js-successbox").hide(), $jform.find(".js-error-control-box .t-input-error").html(""), $jform.find(".js-error-control-box").removeClass("js-error-control-box"), $jform.removeClass("js-send-form-error"), $jform.removeClass("js-send-form-success");
            ...
            try { randomkey = (new Date).getTime() + "=" + parseInt(8 * Math.random()) } catch (e) { randomkey = "rnd=" + parseInt(8 * Math.random()) }
            ...
            try {
                if (window.tildaForm.tildamember = {}, $jform.find(".js-tilda-mauserinfo").remove(), !window.mauser || !window.mauser.code || !window.mauser.email) return !1;
            ...
            } catch (e) { return console.log("addMebersInfoToForm exception:"), console.log(e), !1 }
            return !0
            ...
            var obj = [];
            $.each(window.tcart.products, (function(index, product) { $.isEmptyObject(product) || "yes" === product.deleted || obj.push(product) })), window.tcart.products = obj;
            ...
            window.tcart.delivery && window.tcart.delivery.name && (window.tildaForm.tildapayment.delivery = { name: window.tcart.delivery.name }, window.tcart.delivery && window.tcart.delivery.price >= 0 && (pricedelivery = window.tcart.delivery.price, window.tildaForm.tildapayment.delivery.price = window.tcart.delivery.price, window.tcart.prodamount > 0 && void 0 !== window.tcart.delivery.freedl && window.tcart.delivery.freedl > 0 && (window.tildaForm.tildapayment.delivery.freedl = window.tcart.delivery.freedl, window.tcart.prodamount - proddiscount >= window.tcart.delivery.freedl && (pricedelivery = 0)), arProduct = { name: window.tcart.delivery.name, price: pricedelivery, quantity: 1, id: "delivery" }, window.tildaForm.arProductsForStat.push(arProduct)));
            try {
                var keysForTildapayment;
                ["city", "street", "pickup-name", "pickup-address", "pickup-id", "house", "entrance", "floor", "aptoffice", "phone", "entrancecode", "comment", "service-id", "hash", "postalcode", "country", "userinitials", "onelineaddress"].forEach((function(keyForTildapayment) { window.tcart.delivery && window.tcart.delivery[keyForTildapayment] && (window.tildaForm.tildapayment.delivery[keyForTildapayment] = window.tcart.delivery[keyForTildapayment]) }))
            } catch (e) { console.log(e) }
            $jform.append("")
        }, window.tildaForm.clearTCart = function($jform) {
            if ("y" == $jform.data("formcart")) {
                if (window.clearTCart = !0, window.tcart = { amount: 0, currency: "", system: "", products: [] }, window.tcart.system = "none", "object" == typeof localStorage) try { localStorage.removeItem("tcart") } catch (e) { console.log("Your web browser does not support localStorage.") }
            ...
            arArgs.successurl > "" && window.setTimeout((function() { window.location.href = arArgs.successurl }), 300), $jform.data("successmessage") > "" ? $jform.find(".js-successbox").html($jform.data("successmessage")) : $jform.find(".js-successbox").html(""), $jform.data("successmessage", "");
            ...
            if (!0 !== window.stripeapiiscalled) return window.tildaForm.stripeLoad(), window.setTimeout((function() { window.tildaForm.stripePay($jform, arArgs) }), 200), !1;
            ...
            if (companyname || (companyname = window.location.host), !window.stripehandler) {
                if ("object" != typeof window.StripeCheckout) return window.setTimeout((function() { window.tildaForm.stripePay($jform, arArgs) }), 200), !1;
            ...
            var multiple = 100;
            try { arArgs.multiple && arArgs.multiple > 0 && (multiple = parseInt(arArgs.multiple)) } catch (e) {}
            ...
            if (!0 !== window.cloudpaymentsapiiscalled) return window.tildaForm.cloudpaymentLoad(), window.setTimeout((function() { window.tildaForm.cloudpaymentPay($jform, arArgs) }), 200), !1;
            ...
            if (language || (language = "RUB" == currency || "BYR" == currency || "BYN" == currency || "RUR" == currency ? "ru-RU" : "UAH" == currency ? "uk" : "en-US"), !window.cloudpaymentshandler) {
                if ("object" != typeof window.cp) return window.setTimeout((function() { window.tildaForm.cloudpaymentPay($jform, arArgs) }), 200), !1;
                initCP = { language: language }, arArgs.applePaySupport && "off" == arArgs.applePaySupport && (initCP.applePaySupport = !1), arArgs.googlePaySupport && "off" == arArgs.googlePaySupport && (initCP.googlePaySupport = !1), window.cloudpaymentshandler = new cp.CloudPayments(initCP)
            }
            var arData = {};
            ...
            return $jpopup && 0 != $jpopup.length || ($jpopup = $jform.closest(".t706__cartwin_showed")), $jpopup.data("old-style", $jpopup.attr("style")), $jpopup.attr("style", "z-index:100"), window.tildaForm.orderIdForStat = arArgs.invoiceId, arArgs.skin || (arArgs.skin = "classic"), window.cloudpaymentshandler.charge({ publicId: arArgs.publicId, description: arArgs.description, amount: parseFloat(arArgs.amount), currency: currency, accountId: arArgs.accountId, invoiceId: arArgs.invoiceId, requireEmail: 1 == arArgs.requireEmail, email: arArgs.email, skin: arArgs.skin, data: arData }, (function(options) {
                window.cloudpaymentshandler = !1, $jpopup.attr("style", $jpopup.data("old-style"));
                var virtPage = "/tilda/" + $jform.attr("id") + "/payment/",
                    virtTitle = "Pay order in form " + $jform.attr("id"),
                    virtPrice = arArgs.amount,
                    virtProduct = arArgs.description;
                $("#allrecords").data("tilda-currency", currency), window.Tilda && "function" == typeof Tilda.sendEventToStatistics && Tilda.sendEventToStatistics(virtPage, virtTitle, virtProduct, virtPrice), window.tildaForm.clearTCart($jform), arArgs.successurl > "" && window.setTimeout((function() { window.location.href = arArgs.successurl }), 300), $jform.data("successmessage") > "" ? $jform.find(".js-successbox").html($jform.data("successmessage")) : $jform.find(".js-successbox").html(""), $jform.data("successmessage", "");
                var successcallback = $jform.data("success-callback");
                window.tildaForm.successEnd($jform, arArgs.successurl, successcallback), $jform.trigger("tildaform:aftersuccess")
                ...
                else { $jpopup.find(".t706__cartwin-products").show(), $jpopup.find(".t706__cartwin-prodamount-wrap").show(), $jpopup.find(".t706__form-bottom-text").show(), $jform.find(".t-form__inputsbox").show(); try { tcart__lockScroll() } catch (e) {} }
            })), !1
            ...
            if (arArgs && "fast" == arArgs.condition) window.tildaForm.sendStatAndShowMessage($jform, arArgs, !0);
                ...
                $("#allrecords").append(arArgs.html), $(".t-banktransfer .t-popup__close").off("click"), $(".t-banktransfer .t-popup__close").click((function() {
                    ...
                    try {
                        "function" == typeof tcart__closeCart && (tcart__closeCart(), setTimeout((function() {
                            var $jpopup = $jform.closest(".t-popup_show");
                            $jpopup && 0 != $jpopup.length || ($jpopup = $jform.closest(".t706__cartwin_showed")), $jpopup.find(".t706__cartwin-products").show(), $jpopup.find(".t706__cartwin-prodamount-wrap").show(), $jpopup.find(".t706__form-bottom-text").show(), $jform.find(".t-form__inputsbox").show()
                        }), 300))
                    } catch (e) {}
                    return !1
                ...
                $jbankform.length > 0 && ($jbankform.off("submit"), $jbankform.find(".t-submit").off("click"), $jbankform.find(".t-submit").off("dblclick"), $jbankform.submit((function(e) {
                    ...
                    $.ajax({
                        ...
                        xhrFields: { withCredentials: !1 },
                        success: function(json) {
                            if ($("body").removeClass("t-body_popupshowed"), $jbankform.closest(".t-banktransfer").remove(), json || (json = { error: "Unknown error. Please reload page and try again later." }), json && json.error) return alert(json.error), !1;
                            window.tildaForm.sendStatAndShowMessage($jform, arArgs, !0)
                        },
                        error: function(data) { $("body").removeClass("t-body_popupshowed"), $jbankform.remove(), alert(data) },
                        timeout: 15e3
                    })
                })))
                    ...
                    success: function(json) {
                        ...
                        if (btnformsubmit.removeClass("t-btn_sending"), btnformsubmit.data("form-sending-status", "0"), btnformsubmit.data("submitform", ""), json && json.error) {
                            ...
                            if (window.Tilda && "function" == typeof Tilda.sendEventToStatistics) {
                                ...
                                try { Tilda.sendEventToStatistics(virtPage, virtTitle, virtProduct, virtPrice) } catch (e) { console.log(e) }
                                window.dataLayer && window.dataLayer.push({ event: "submit_" + $jform.attr("id") })
                            } else {
                                try { "undefined" != typeof ga && ga && "tilda" != window.mainTracker && ga("send", { hitType: "pageview", page: virtPage, title: virtTitle }), window.mainMetrika > "" && window[window.mainMetrika] && window[window.mainMetrika].hit(virtPage, { title: virtTitle, referer: window.location.href }) } catch (e) { console.log(e) }
                                window.dataLayer && window.dataLayer.push({ event: "submit_" + $jform.attr("id") })
                            }
                            try { $jform.trigger("tildaform:aftersuccess"), formsendedcallback && formsendedcallback.length > 0 && eval(formsendedcallback + "($jform);") } catch (e) { console.log(e) }
            ...
            $(".js-tilda-mask").each((function() {
                ...
                mask && !$(this).data("tilda-mask-init") && (maskplaceholder && maskplaceholder > "" ? $(this).mask("" + mask, { placeholder: "" + maskplaceholder }) : $(this).mask("" + mask), $(this).data("tilda-mask-init", "1"))
            }))
        ...
        })), $(".r").on("dblclick", ".js-form-proccess [type=submit]", (function(e) { return e.preventDefault(), !1 })), $(".r").off("click", ".js-form-proccess [type=submit]"), $(".r").on("click", ".js-form-proccess [type=submit]", (function(event) {
