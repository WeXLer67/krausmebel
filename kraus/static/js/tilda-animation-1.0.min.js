function t_animate__getAttrByRes(t, a) { var e, n = $(window).width(); return n >= 1200 ? e = t.attr("data-animate-" + a) : "y" == t.closest(".t396__elem").attr("data-animate-mobile") ? n >= 960 ? ((e = t.attr("data-animate-" + a + "-res-960")) || (e = t.attr("data-animate-" + a)), e) : n >= 640 ? ((e = t.attr("data-animate-" + a + "-res-640")) || (e = t.attr("data-animate-" + a + "-res-960")), e || (e = t.attr("data-animate-" + a)), e) : n >= 480 ? ((e = t.attr("data-animate-" + a + "-res-480")) || (e = t.attr("data-animate-" + a + "-res-640")), e || (e = t.attr("data-animate-" + a + "-res-960")), e || (e = t.attr("data-animate-" + a)), e) : n >= 320 ? ((e = t.attr("data-animate-" + a + "-res-320")) || (e = t.attr("data-animate-" + a + "-res-480")), e || (e = t.attr("data-animate-" + a + "-res-640")), e || (e = t.attr("data-animate-" + a + "-res-960")), e || (e = t.attr("data-animate-" + a)), e) : void 0 : void t.css("transition", "none") }
...
function t_animate__checkMobile(t) { return t.filter(function() { return "y" === $(this).closest(".t396__elem").attr("data-animate-mobile") || ($(this).removeClass("t-animate"), !1) }), t }
...
function t_animate__startAnimation() {
    ...
    $(window).width() < 1200 && (t = t_animate__checkMobile(t), a = t_animate__checkMobile(a), e = t_animate__checkMobile(e)), (void 0 !== t && 0 != t.length || void 0 !== e && 0 != e.length || void 0 !== a && 0 != a.length) && (t_animate__setAnimationState(t, a, e), t = t.filter(".r:has(.t-animate_wait)"), e = e.filter(".t-animate_wait"), a = a.filter(".r:has(.t-animate_wait)"), n(), $(window).bind("resize", t_throttle(n, 200)), setInterval(n, 5e3), $(window).bind("scroll", t_throttle(function() { t_animate__animateOnScroll(t, a, e) }, 200)), $(".r").find(".t-popup").bind("scroll", t_throttle(function() {
    ...
    t.each(function() {
        ...
        if (n = n.split(";").filter(function(t, a) { return n.split(";").indexOf(t) === a }).join(";"), !($(this).offset().top < a - 500) && e.length > 0) {
            ...
            if (-1 === e.indexOf(r) && (o = r = r.split(" ")[0]), "" !== r) {
                ...
                t_animate__changeNumberOnZero(t, e.replace(o, "num")), t.find("span:not(.t-animate__number)").each(function() { $(this).attr("style", n) })
            }
        }
    })
}
    ...
    t.each(function() {
        ...
        if (t.find("span:not(.t-animate__number):first").each(function() { e = $(this).attr("style") }), a) {
            var n = a.match(/\d+\.\d+|\d+,\d+/g),
                i = a.match(/\d+/g),
                s = [];
            a.replace(/(\d)(?= \d) /g, "$1").split(" ").forEach(function(t) { isNaN(parseInt(t.replace(/[^\d., ]+/g, ""), 10)) || s.push(t.replace(/[^\d., ]+/g, "")) });
            var r = 0,
                o = !1;
            ...
            var _ = [];
            t.find(".t-animate__number").each(function() { _.push($(this).text()) }), s.forEach(function(n, s) {
                void 0 !== _[s] && $({ animateCounter: _[s] }).animate({ animateCounter: n }, {
                    duration: 1500,
                    easing: "swing",
                    step: function(a) {
...
function t_animate__getElemsOffsets(t) { for (var a = 0; a < t.length; a++) t[a].curTopOffset = $(window).scrollTop() + t[a].getBoundingClientRect().top }
