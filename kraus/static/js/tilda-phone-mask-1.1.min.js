function t_ready(n) { "loading" != document.readyState ? n() : document.addEventListener("DOMContentLoaded", n) }

function t_siblings(n, e) { return n.parentNode ? Array.prototype.filter.call(n.parentNode.children, function(n) { return n.classList.contains(e) }) : [] }

function t_getParent(n, e) {
    for (; 1 === n.nodeType;) {
        if (n.classList && n.classList.contains(e)) return n;
        n = n.parentNode
    }
}

function t_form_phonemask__initPhoneMask() {
    var n = document.querySelectorAll(".js-phonemask-input");
    Array.prototype.forEach.call(n, t_form_phonemask_load)
}

function t_form_phonemask_load_one(n) {
    n = document.querySelectorAll("#rec" + n + " .js-phonemask-input");
    Array.prototype.forEach.call(n, t_form_phonemask_load)
}

function t_form_phonemask_load(n) {
    var e, t, a;
    void 0 !== n.getAttribute && (n instanceof Element || (n = n[0]), e = n.getAttribute("data-phonemask-id"), t = n.getAttribute("data-phonemask-lid"), a = n.getAttribute("data-phonemask-maskcountry") || "", n.setAttribute("data-phonemask-init", "yes"), setTimeout(function() { try { t_form_phonemask_init(e, t, a) } catch (n) { console.log(n) } }, 1e3))
}

function t_form_phonemask_init(e, t, n) {
    var a;
    n && "undefined" !== n ? t_form_phonemask_initPhoneMaskForm(e, t, n) : window.geo_iso && "undefined" !== window.geo_iso ? t_form_phonemask_initPhoneMaskForm(e, t, window.geo_iso) : ((a = new XMLHttpRequest).open("GET", "https://geo.tildacdn.com/geo/country/", !0), a.onload = function() {
        var n;
        200 <= a.status && a.status < 400 ? (n = a.responseText, t_form_phonemask_initPhoneMaskForm(e, t, n)) : t_form_phonemask_initPhoneMaskForm(e, t, "")
    }, a.onerror = function() { t_form_phonemask_initPhoneMaskForm(e, t, "") }, a.send())
}

function t_form_phonemask_initPhoneMaskForm(n, e, t) {
    var a, p, o, i, s, m = document.querySelector("#rec" + n),
        r = (r = m.querySelector('[data-input-lid="' + e + '"]')) || (window.tildamode && "zero" === window.tildamode ? (r = m.querySelector('.tn-artboard [data-input-lid="' + e + '"]')) || m.querySelector(".tn-artboard") : (r = document.querySelector('[data-input-lid="' + e + '"]')) || document.body);
    r.getAttribute("data-init-mask") || (t_form_phonemask__replaceInput(r), m.querySelector(".t-input-phonemask__wrap").classList.contains("t-input-phonemask__wrap-style") || t_form_phonemask__addStyle(), a = r.querySelector(".t-input-phonemask"), "string" == typeof t && t || (t = ""), 0 < t.length && (t = t.toLowerCase()), 2 < t.length && (t = ""), (p = t_form_phonemask__getCountriesList())[t] ? o = p[t] : (o = { n: "Russian Federation (Российская Федерация)", c: "+7", m: "+7(999) 999-99-99" }, t = "ru"), a.setAttribute("data-phonemask-code", 0 < t.length ? o.c : ""), a.setAttribute("data-phonemask-mask", 0 < t.length ? o.m : ""), t_form_phonemask__calcMaxlength(a), i = r.querySelector(".t-input-phonemask__select-flag"), s = r.querySelector(".t-input-phonemask__select-code"), n = a.getAttribute("data-phonemask-mask"), e = a.getAttribute("data-phonemask-code"), 0 < t.length && (localStorage.setItem("iso_code", t), i.setAttribute("data-phonemask-flag", t), s.innerHTML = o.c, n && a.setAttribute("placeholder", n.substr(e.length).replace(/^-+/, "")), t_form_phonemask__changeMinLength(a.getAttribute("placeholder"), e, r)), t_form_phonemask__addCurrentStyle(r), r.querySelector(".t-input-phonemask__options-wrap").innerHTML = t_form_phonemask__getDrawSelector(p), t_form_phonemask__initSelectEvents(m, r, p), r.setAttribute("data-init-mask", "yes"))
}

function t_form_phonemask__replaceInput(n) {
    var e, t, a, p, o = n.querySelector(".js-phonemask-input");
    o && (e = o.getAttribute("name"), t = o.getAttribute("data-tilda-req") ? 'data-tilda-req="1"' : "", a = !!o.classList.contains("t-input_bbonly"), p = o.getAttribute("style"), o.outerHTML = '<div class="t-input t-input-phonemask__wrap" style="' + p + '"><div class="t-input-phonemask__select"><span class="t-input-phonemask__select-flag" data-phonemask-flag=""></span><span class="t-input-phonemask__select-triangle"></span><span class="t-input-phonemask__select-code"></span></div><div class="t-input-phonemask__options-wrap" data-nosnippet></div><input type="tel" class="t-input t-input-phonemask" name="tildaspec-phone-part[]" value="" placeholder=""><input type="hidden" class="js-phonemask-result js-tilda-rule" data-tilda-rule="phone" name="' + e + '" value="" ' + t + ' tabindex="-1">        </div>', n = n.querySelector(".t-input-phonemask__wrap"), a && n.classList.add("t-input_bbonly"), 0 !== (n = t_siblings(n, "t-input__vis-ph")).length && Array.prototype.forEach.call(n, function(n) { n.remove() }))
}

function t_form_phonemask__calcMaxlength(n) { var e = n.getAttribute("data-phonemask-mask").substr(n.getAttribute("data-phonemask-code").length); "-" === e.charAt(0) && (e = e.substring(1)), n.setAttribute("maxlength", e.length), n.setAttribute("data-phonemask-without-code", e) }

function t_form_phonemask__addCurrentStyle(n) {
    var e = n.querySelector(".t-input-phonemask__wrap"),
        t = n.querySelector(".t-input-phonemask"),
        a = n.querySelector(".t-input-block"),
        p = n.querySelector(".t-input-phonemask__select-code"),
        o = e.style.color,
        n = e.style.fontSize,
        e = e.style.fontWeight;
    a.style.overflow = "initial", "rgb(0, 0, 0)" !== o && (t.style.color = o), t.style.fontSize = n, t.style.fontWeight = e, p.style.fontSize = n, p.style.fontWeight = e
}

function t_form_phonemask__getDrawSelector(n) { var e, t = ""; for (e in t += "<noindex>", n) t += '<div class="t-input-phonemask__options-item" id="t-phonemask_' + e + '" data-phonemask-name="' + n[e].n + '" data-phonemask-mask="' + n[e].m + '" data-phonemask-country-code="' + e + '" data-phonemask-code="' + n[e].c + '">', t += '<div class="t-input-phonemask__options-name">' + n[e].n + "</div>", t += '<span class="t-input-phonemask__options-code">' + n[e].c + "</span>", t += '<span class="t-input-phonemask__options-flag t-input-phonemask__options-flag_' + e + '"></span>', t += "</div>"; return t += "</noindex>" }

function t_form_phonemask__initSelectEvents(n, t, i) {
    var a = n.querySelectorAll(".t-cover, .t396__artboard"),
        p = t.querySelector(".t-input-phonemask"),
        e = t.querySelector(".t-input-phonemask__select"),
        o = t.querySelector(".t-input-phonemask__options-wrap"),
        n = t.querySelectorAll(".t-input-phonemask__options-item"),
        s = "",
        m = "";

    function r() {
        var n = document.querySelector(".t-input-phonemask__options-wrap_open");
        n && n.classList.remove("t-input-phonemask__options-wrap_open")
    }

    function c() { t_form_phonemask__chooseCountry(t, this), t_form_phonemask__calcMaxlength(p), r(), 1 === a.length && (a[0].style.overflow = "") }

    function x(n) {
        var e = t_getParent(n.target, "t-input-phonemask__options-wrap"),
            n = t_getParent(n.target, "t-input-phonemask__select");
        e || n || (r(), 1 === a.length && (a[0].style.overflow = ""))
    }
    ...
    function l(n) {
        ...
        if (e) {
            var t = /[-[\]/{}()*+?.\\^$|]/g,
                a = e.querySelector(".t-input-phonemask__options-item_chosen"),
                p = [];
            if (a && a.classList.remove("t-input-phonemask__options-item_chosen"), 48 <= n.keyCode && n.keyCode <= 57 || 96 <= n.keyCode && n.keyCode <= 105)
                for (var o in s = (s += n.key).replace(t, "\\$&"), i) t_form_phonemask__searchCountry(e, s, p, o, i[o].c);
            else if (65 <= n.keyCode && n.keyCode <= 90 || 32 == n.keyCode)
                for (var o in s = (s += n.key).replace(t, "\\$&"), i) t_form_phonemask__searchCountry(e, "^" + s, p, o, i[o].n);
            clearTimeout(m), m = setTimeout(function() { s = "" }, 1500)
        }
    }
    t_form_phonemask__changeVal(t, p), e.addEventListener("click", function() { o.classList.contains("t-input-phonemask__options-wrap_open") ? r() : (r(), o.classList.add("t-input-phonemask__options-wrap_open")), 1 === a.length && (a[0].style.overflow = "unset") }), p.addEventListener("input", function() {
        var n = this,
            e = n.value;
        "(" !== e && e || (n.value = "", t.querySelector(".js-phonemask-result").value = ""), n.setAttribute("data-phonemask-current", e), t_form_phonemask__addNumberMask(t_form_phonemask__copypasteHandling(n, n.getAttribute("data-phonemask-without-code")), n), t_form_phonemask__changeVal(t, p), "+7" === n.getAttribute("data-phonemask-code") && 1 === n.value.indexOf("89") && (n.value = n.value.replace("89", "9"))
    }), Array.prototype.forEach.call(n, function(n) { n.addEventListener("click", c) }), document.addEventListener("mouseup", x), document.addEventListener("keyup", l), document.querySelector('[data-init-mask="yes"]') || (document.addEventListener("mouseup", x), document.addEventListener("keyup", l))
}

function t_form_phonemask__copypasteHandling(n, e) {
    var t = n.value,
        a = t.match(/[0-9]/g) ? t.match(/[0-9]/g) : t;
    return a.length > e.match(/[0-9]/g).join("").length && (t = a.splice(n.getAttribute("data-phonemask-code").match(/[0-9]/g).length).join("")), t
}

function t_form_phonemask__addNumberMask(n, e) {
    var t = e.getAttribute("data-phonemask-code"),
        t = e.getAttribute("data-phonemask-mask").substr(t.length),
        n = n.match(/\d+/g),
        a = (n = n ? n.join("") : "").split(""),
        p = t.match(/(\+|\d+|[\s()-]|9+)/g),
        o = "";
    if (p) {
        ...
        o = (o = o.replace(/[\s()-]+$/, "")).replace(/^-+/, ""), e.value = o
    }
}

function t_form_phonemask__changeVal(n, e) { e.value && (n.querySelector(".js-phonemask-result").value = e.getAttribute("data-phonemask-code") + " " + e.value) }

function t_form_phonemask__chooseCountry(n, e) {
    var t = n.querySelector(".t-input-phonemask"),
        a = n.querySelector(".t-input-phonemask__select-code"),
        p = n.querySelector(".t-input-phonemask__select-flag"),
        o = e.getAttribute("data-phonemask-code"),
        i = e.getAttribute("data-phonemask-mask"),
        s = e.getAttribute("data-phonemask-country-code"),
        e = t.getAttribute("data-phonemask-current");
    t.setAttribute("data-phonemask-code", o), t.setAttribute("data-phonemask-mask", i), t.setAttribute("placeholder", i.substr(o.length).replace(/^-+/, "")), a.innerHTML = o, p.setAttribute("data-phonemask-flag", s), localStorage.setItem("iso_code", s), t.focus(), e && t_form_phonemask__addNumberMask(e, t), t_form_phonemask__changeVal(n, t), t_form_phonemask__changeMinLength(t.getAttribute("placeholder"), o, n)
}

function t_form_phonemask__searchCountry(n, e, t, a, p) { e = new RegExp(e, "i"); - 1 !== p.search(e) && (t.push(n.querySelector("#t-phonemask_" + a)), t[0].classList.add("t-input-phonemask__options-item_chosen"), e = n.querySelector(".t-input-phonemask__options-item_chosen").getBoundingClientRect().top, a = n.getBoundingClientRect().top, t = document.body.scrollTop + n.scrollTop, n.scrollTop = e - a + t) }

function t_form_phonemask__changeMinLength(n, e, t) {
    var a, p, o = 1;
    n && e && (p = t.querySelector(".t-input-phonemask"), a = t.querySelector(".js-phonemask-result"), p = p.getAttribute("data-phonemask-code"), o = e.length + 1 + n.length - ({ "+49": 1, "+372": 1, "+355": 1, "+213": 1, "+975": 1, "+267": 1, "+359": 1, "+53": 1, "+36": 1, "+961": 1, "+54": 1, "+82": 1, "+880": 1, "+970": 1, "+385": 1, "+43": 1, "+357": 1, "+61": 1, "+507": 1, "+55": 1, "+90": 1, "+33": 1, "+593": 1, "+383": 1, "+39": 1, "+971": 1, "+86": 1, "+972": 2, "+234": 2, "+44": 4, "+358": 4 }[p] || 0)), a.setAttribute("data-tilda-rule-minlength", o)
}
